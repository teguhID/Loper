        ...
        <div class="container hero">
            <div class="row">
                <div class="col-12 col-lg-6 col-xl-5 offset-xl-1" style="height: 522px;">
                    <h1 style="margin-top: 90px;padding-right: 30px;">Anda Mencari Karyawan ??</h1>
                    <p style="padding-right: 30px;">Daftarkan segera perusahaan anda untuk mendapatkan karyawan terbaik di sini</p>
                </div>
                <div class="col-md-5 col-lg-5 offset-lg-1 offset-xl-0 d-none d-lg-flex justify-content-lg-center align-items-lg-center phone-holder">
                    <form method="post" action="{{ route('register') }}">
                        ...
                        <h2 class="text-center" style="padding-top: 60px;color: rgb(255,255,255);padding-bottom: 30px;font-size: 20px;font-family: 'Roboto Slab', serif;">Bergabunglah Bersama<br>Kami</h2>
