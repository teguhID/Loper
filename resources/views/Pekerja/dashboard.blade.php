        ...
        <div class="row justify-content-center features" style="background-color: #adadad;padding: 37px;padding-bottom: 20px;">
            <div class="col-sm-6 col-md-5 col-lg-4 item">
                <div class="box"><i class="fa fa-send icon"></i>
                    ...
                    <p class="description" style="color: rgb(255,255,255);min-height: 90px;font-size: 17px;">Kamu punya <strong>{{ $listLowongan }} lamaran</strong> yang telah terkirim</p><a class="learn-more" href="{{ url('pekerja/cvTerkirim') }}" style="color: rgb(0,0,0);font-weight: bold;">Lihat Semua »</a></div>
            </div>
            <div class="col-sm-6 col-md-5 col-lg-4 item">
                <div class="box"><i class="fa fa-clock-o icon"></i>
                    <h3 class="name">Update CV</h3>
                    <p class="description" style="color: rgb(255,255,255);min-height: 90px;font-size: 15px;">Terakhir kamu update CV tanggal 12 Januari 2019, Ayo update cv kamu agar perusahaan tertarik</p><a class="learn-more" href="{{ url('pekerja/editCv') }}" style="color: rgb(0,0,0);font-weight: bold;">Update CV »</a></div>
            </div>
        </div>
    </div>
</div>
