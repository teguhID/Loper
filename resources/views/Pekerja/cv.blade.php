...
@section('content')
    <div class="border-white shadow-sm profile-card" style="padding-top: 57px;margin-bottom: 20px;">
        ...
        <h2 class="text-center d-sm-flex d-xl-flex justify-content-sm-center justify-content-xl-center align-items-xl-center" style="padding-top: 0px;font-size: 37px;padding-bottom: 0px;"><a class="btn btn-primary" role="button" style="width: 160px;height: 49px;padding-top: 12px;" href="{{ url('pekerja/editCv') }}"><i class="fa fa-pencil-square-o" style="padding-right: 11px;"></i>Update CV</a></h2>
    </div>
