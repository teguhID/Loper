...
<body>
    <nav class="navbar navbar-dark navbar-expand-lg fixed-top bg-dark" id="mainNav">
        <div class="container"><a id="home" class="btn d-xl-flex align-items-xl-center" role="button" style="color: rgb(255,255,255);padding-left: 24px;padding-bottom: 12px;padding-top: 12px;padding-right: 24px;" href="{{ url('/home') }}"><i class="fa fa-home" style="font-size: 27px;padding-left: 0px;padding-right: 8px;"></i>Home</a>
            <button
