...
class PekerjaModel extends Model
{
    ...
    protected $fillable = ['id_pelamar', 'nama','tempat_lahir', 'tanggal_lahir', 'alamat', 'kota', 'negara', 'jenis_kelamin', 'status', 'agama', 'berat_badan', 'tinggi_badan', 'phone', 'email', 'blog', 'web', 'keahlian1', 'keahlian2', 'keahlian3', 'keahlian4','facebook', 'twitter', 'instagram', 'linkedin',
